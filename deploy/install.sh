...
printf "\n"
printf "       ${BOLD}sudo -u ratatosk sh -c 'cd /etc/ratatosk && ratatosk-server init'${RESET}\n"
printf "\n"
printf "${BOLD}Next steps:${RESET}\n"
printf "  1. Configure DNS records (see deployment guide)\n"
printf "  2. Run the setup wizard:  ${BOLD}sudo -u ratatosk sh -c 'cd /etc/ratatosk && ratatosk-server init'${RESET}\n"
